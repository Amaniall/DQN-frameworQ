...
HYPER_PARAMS = {
    ...
    'bs': 32,                                   # Batch size
    'min_mem': 32,                          # Replay memory buffer min size
    'max_mem': 64,                         # Replay memory buffer max size
    ...
    'max_episode_steps': 1,                  # Time limit episode steps
    'max_total_steps': 1,                       # Max total training steps if > 0, else inf training
